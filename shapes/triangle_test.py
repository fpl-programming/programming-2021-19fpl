...
class TriangleTestCase(unittest.TestCase):
    ...
    def test_triangle_get_half_the_perimeter(self):
        """
        Creates a triangle.
        Tests that the half the perimeter is calculated correctly.
        """
        triangle = Triangle(0, 3, 4, 5)
        self.assertEqual(triangle.get_half_the_perimeter(), 6)
